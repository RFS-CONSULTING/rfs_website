<x-app-layout>
  <x-slot name="title">
    <title>Toutes nos formations -- RFS CONSULTING</title>
  ...
  <x-slot name="title">
    <title>Nos Formations -- RFS CONSULTING</title>
      ...
      <section class="container">
        ...
        <div class="d-lg-flex align-items-center justify-content-between py-4 mt-lg-2">
          <h1 class="me-3">Formations</h1>
            <form class="d-md-flex mb-3" action="{{ route('formation.search')}}">
              @csrf
              ...
              <div class="position-relative" style="min-width: 300px;">
                <input name="searchquery" type="text" class="form-control pe-5" placeholder="Rechercher des formations">
