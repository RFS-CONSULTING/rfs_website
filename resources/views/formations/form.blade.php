<x-app-layout>
    ...
    <x-slot name="title">
        <title>Formulaire Formation Certifiée</title>
        ...
        <meta property="og:url"           content="https://rfs-congo.com/formation-form" />
        <meta property="og:type"          content="website" />
        <meta property="og:title"         content="Formation Certifiée" />
    ...
    <section class="container">
        <nav class="py-4 mb-2 my-lg-3" aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Formulaire formation</li>
            </ol>
        </nav>
    </section>
            ...
            <div class=" ">
                <div class="row d-flex justify-content-center">
                    <div class="col-md-8 text-center mt-4">
                        ...
                        <p class="text-mobile">Formation en ligne (ZOOM) et en présentiel (Limete/Kinshasa/RDC).</p>
                        <hr>
                        <span>Tous les champs marqués d'un <span class="text-danger">*</span> sont obligatoires et doivent être remplis </span>
                    </div>
                </div>
                <div class="d-flex justify-content-center">
                    <form action="/formation/subscribe" method="POST" class=" ">
                        @csrf
                        <div class="row  rounded p-2 mt-2  ">
                            ...
                            <div class="col-md-6 mb-2">
                                <label for="exampleFormControlInput1" class="form-label ">Nom de la Compagnie/Université ? <span class="text-danger">*</span> </label>
                                <input type="text" name="compagnie" class="form-control" id="exampleFormControlInput1" placeholder="Entrez le nom de votre compagnie" required>
                            </div>
                            <div class="col-md-6 mb-2">
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" name="address2" class="form-control" id="inputAddress2" placeholder="2100 avenue Gangi, ...">
                            </div>
                            <div class="col-md-6 mb-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-2">
                                        <select class="form-select " name="outils" aria-label="Default select example"  >
                                            <option value="" selected>Choisissez le type</option>
                                            <option value="Aucun">Aucun</option>
                                            <option value="Formation sur le logiciel R">Formation sur le logiciel R</option>
                                            <option value="Formation sur l'application OsmAnd">Formation sur l'application OsmAnd</option>
                                            <option value="Formation sur le logiciel SPSS">Formation sur le logiciel SPSS</option>
                                            <option value="Formation sur l'appareil GPS">Formation sur l'appareil GPS</option>
                                            <option value="Formation sur le logiciel KoBo Collect">Formation sur le logiciel KoBo Collect</option>
